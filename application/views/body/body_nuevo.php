				...
				<div class="row">
					<div class="col-xs-12 col-md-10 col-lg-8">
						<div class="card mb-4">
							...
							<form id="multasform" method="post">
								<div class="card-body">
									<!-- row:1 -->
									<div class="row">
								...
								<div class="card-footer">
									<button class="btn btn-success" onclick="multar(event);">Aceptar</button>
									<button class="btn btn-warning" onclick="cancelar(event)">Cancelar</button>
								</div>
							</form>
						</div>
					</div>
